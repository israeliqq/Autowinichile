...
<head>
    ...
    <link rel="stylesheet" type="text/css"  href="<?=base_url('assets');?>/css/lightbox.min.css">
    <link rel="stylesheet" type="text/css"  href="<?=base_url('assets');?>/css/jnoty.css">

    <!-- Custom stylesheet -->
    <link rel="stylesheet" type="text/css" href="<?=base_url('assets');?>/css/sidebar.css">
    <link rel="stylesheet" type="text/css" href="<?=base_url('assets');?>/css/style.css">
    <link rel="stylesheet" type="text/css" id="style_sheet" href="<?=base_url('assets');?>/css/skins/yellow.css">

    <!-- Favicon icon -->
    <link rel="shortcut icon" href="<?=base_url('assets');?>/img/favicon.ico" type="image/x-icon" >

    <!-- Google fonts -->
    <link href="<?=base_url('assets');?>/https://fonts.googleapis.com/css?family=Poppins:300,400,600,700%7CUbuntu:300,400,700" rel="stylesheet">
    <link href="<?=base_url('assets');?>/https://fonts.googleapis.com/css?family=Montserrat:300,400,500,600,700,800,900&display=swap" rel="stylesheet">
