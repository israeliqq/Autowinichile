        ...
        <div class="row">
            <div class="col-xl-4 col-lg-3 col-md-6 col-sm-6">
                <div class="footer-item clearfix">
                    <img  src="<?=base_url('assets');?>/img/logos/logo.png" alt="logo" class="f-logo">
                    ...
                    <div class="row modal-raw">
                        <div class="col-lg-6 modal-left">
                            <div class="item active">
                                <img  src="<?=base_url('assets');?>/img/car-11.png" alt="best-car" class="img-fluid">
                                <div class="sobuz">
                                    <div class="price-box">
...
<script   src="<?=base_url('assets');?>/js/jnoty.js"></script>
