            ...
            <div class="carousel-item banner-max-height active item-bg">
                ...
                <div class="carousel-content container banner-info bi-2">
                    <div class="text-center">
                        <h1>Welcome to <span>Auto Car</span></h1>
                        <p>
...
<!-- Search area 3 start -->
<div class="search-area-3 sa-5 clearfix d-md-none d-lg-none d-xl-none">
    <div class="container">
        ...
        <div class="row filter-portfolio">
            <div class="cars">
                <div class="col-lg-4 col-md-6 col-sm-12 filtr-item" data-category="3, 2">
                    <div class="car-box">
                        <div class="car-image">
                            <img class="d-block w-100" src="img/car/car-1.png" alt="car-photo">
                ...
                <div class="col-lg-4 col-md-6 col-sm-12 filtr-item" data-category="3, 2, 1">
                    <div class="car-box">
                        <div class="car-image">
                            <img class="d-block w-100" src="img/car/car-2.png" alt="car-photo">
                            <div class="tag">Featured</div>
                            <div class="facilities-list clearfix">
                                <ul>
                                    <li>
                ...
                <div class="col-lg-4 col-md-6 col-sm-12 filtr-item" data-category="1, 2">
                    <div class="car-box">
                        <div class="car-image">
                            <img class="d-block w-100" src="img/car/car-3.png" alt="car-photo">
                            <div class="tag">Featured</div>
                            <div class="facilities-list clearfix">
                                <ul>
                                    <li>
                ...
                <div class="col-lg-4 col-md-6 col-sm-12 filtr-item" data-category="3, 2">
                    <div class="car-box">
                        <div class="car-image">
                            <img class="d-block w-100" src="img/car/car-4.png" alt="car-photo">
                            <div class="tag">Featured</div>
                            <div class="facilities-list clearfix">
                                <ul>
                                    <li>
                ...
                <div class="col-lg-4 col-md-6 col-sm-12 filtr-item" data-category="2, 1">
                    <div class="car-box">
                        <div class="car-image">
                            <img class="d-block w-100" src="img/car/car-5.png" alt="car-photo">
                            <div class="tag">Featured</div>
                            <div class="facilities-list clearfix">
                                <ul>
                                    <li>
                ...
                <div class="col-lg-4 col-md-6 col-sm-12 filtr-item" data-category="3, 1">
                    <div class="car-box">
                        <div class="car-image">
                            <img class="d-block w-100" src="img/car/car-6.png" alt="car-photo">
                            <div class="tag">Featured</div>
                            <div class="facilities-list clearfix">
                                <ul>
                                    <li>
                ...
                <div class="row">
                    <div class="col-lg-6 col-md-6 col-sm-12">
                        <div class="single-info">
                            ...
                            <p>Lorem ipsum dolor sit amet, consectetur adipisicing elit, sed do eiusmod tempor Lorem</p>
                        </div>
                    </div>
                    <div class="col-lg-6 col-md-6 col-sm-12">
                        <div class="single-info">
                    ...
                    <div class="col-md-12 col-sm-12 col-pad">
                        <div class="latest-offers-box">
                            <div class="latest-offers-box-inner">
                                <div class="latest-offers-box-overflow">
                                    <div class="latest-offers-box-photo">
                                        <img class="img-fluid" src="img/latest-offers/img-1.png" alt="latest-offers">
                                    </div>
                                    <div class="info">
            ...
            <div class="row slick-carousel" data-slick='{"slidesToShow": 2, "responsive":[{"breakpoint": 1024,"settings":{"slidesToShow": 2}}, {"breakpoint": 768,"settings":{"slidesToShow": 1}}]}'>
                <div class="slick-slide-item">
                    <div class="row team-2">
                        <div class="col-xl-5 col-lg-6 col-md-12 col-sm-12 col-pad">
                            <div class="photo">
                                <img src="img/avatar/avatar-11.png" alt="team-2" class="img-fluid">
                        ...
                        <div class="col-xl-7 col-lg-6 col-md-12 col-sm-12 col-pad align-self-center">
                            <div class="detail">
                                <h4>
                                    <a href="agent-detail.html">Carolyn Stone</a>
                                </h4>
                                <h5>Creative Director</h5>
                                <div class="contact">
                                    <ul>
                                        <li>
                                            <i class="flaticon-pin"></i><a tabindex="-1">44 New Design Street,</a>
                                        </li>
                                        <li>
                                        ...
                                        <li>
                                            <i class="flaticon-fax"></i><a href="tel:+554XX-634-7071"> +01 4XX-634-6582</a>
                                        </li>
                                    </ul>
                                </div>
                            </div>
                ...
                <div class="slick-slide-item">
                    <div class="row team-2">
                        <div class="col-xl-5 col-lg-6 col-md-12 col-sm-12 col-pad">
                            <div class="photo">
                                <img src="img/avatar/avatar-9.png" alt="team-2" class="img-fluid">
                                <ul class="social-list clearfix">
                                    <li><a href="#" class="facebook-bg"><i class="fa fa-facebook"></i></a></li>
                                    <li><a href="#" class="twitter-bg"><i class="fa fa-twitter"></i></a></li>
                                    <li><a href="#" class="google-bg"><i class="fa fa-google-plus"></i></a></li>
                            ...
                            <div class="detail">
                                ...
                                <div class="contact">
                                    <ul>
                                        ...
                                        <li>
                                            <i class="flaticon-mail"></i><a href="mailto:info@themevessel.com" tabindex="-1">info@themevessel.com</a>
                                        </li>
                                        <li>
                                            <i class="flaticon-phone"></i><a href="tel:+554XX-634-7071" tabindex="-1"> +55 4XX-634-7071</a>
                                        </li>
                                        <li>
                                            <i class="flaticon-fax"></i><a href="tel:+554XX-634-7071" tabindex="-1"> +01 4XX-634-6582</a>
                                        </li>
                                    </ul>
                                </div>
                            </div>
                ...
                <div class="slick-slide-item">
                    <div class="row team-2">
                        <div class="col-xl-5 col-lg-6 col-md-12 col-sm-12 col-pad">
                            <div class="photo">
                                <img src="img/avatar/avatar-12.png" alt="team-2" class="img-fluid">
                                <ul class="social-list clearfix">
                                    <li><a href="#" class="facebook-bg"><i class="fa fa-facebook"></i></a></li>
                                    <li><a href="#" class="twitter-bg"><i class="fa fa-twitter"></i></a></li>
                                    <li><a href="#" class="google-bg"><i class="fa fa-google-plus"></i></a></li>
                        ...
                        <div class="col-xl-7 col-lg-6 col-md-12 col-sm-12 col-pad align-self-center">
                            <div class="detail">
                                <h4>
                                    <a href="agent-detail.html">Brandon Miller</a>
                                </h4>
                                <h5>Manager</h5>
                                <div class="contact">
                                    <ul>
                ...
                <div class="slick-slide-item">
                    <div class="row team-2">
                        <div class="col-xl-5 col-lg-6 col-md-12 col-sm-12 col-pad">
                            <div class="photo">
                                <img src="img/avatar/avatar-10.png" alt="team-2" class="img-fluid">
                                <ul class="social-list clearfix">
                                    <li><a href="#" class="facebook-bg"><i class="fa fa-facebook"></i></a></li>
                                    <li><a href="#" class="twitter-bg"><i class="fa fa-twitter"></i></a></li>
                                    <li><a href="#" class="google-bg"><i class="fa fa-google-plus"></i></a></li>
                    ...
                    <div class="row slick-carousel" data-slick='{"slidesToShow": 2, "responsive":[{"breakpoint": 1024,"settings":{"slidesToShow": 2}}, {"breakpoint": 768,"settings":{"slidesToShow": 1}}]}'>
                        <div class="slick-slide-item">
                            <div class="testimonial-info-box">
                                <div class="profile-user">
                                    <div class="avatar">
                                        <img src="img/avatar/avatar-1.png" alt="testimonial-2">
                                    </div>
                                </div>
                                <h5>
                        ...
                        <div class="slick-slide-item">
                            <div class="testimonial-info-box">
                                <div class="profile-user">
                                    <div class="avatar">
                                        <img src="img/avatar/avatar-3.png" alt="testimonial-2">
                                    </div>
                                </div>
                                <h5>
                        ...
                        <div class="slick-slide-item">
                            <div class="testimonial-info-box">
                                <div class="profile-user">
                                    <div class="avatar">
                                        <img src="img/avatar/avatar-2.png" alt="testimonial-2">
                                    </div>
                                </div>
                                <h5>
...
<div class="blog content-area bg-grea-3">
    <div class="container">
        ...
        <div class="slick-slider-area clearfix">
            <div class="row slick-carousel" data-slick='{"slidesToShow": 2, "responsive":[{"breakpoint": 1024,"settings":{"slidesToShow": 2}}, {"breakpoint": 768,"settings":{"slidesToShow": 1}}]}'>
                <div class="slick-slide-item">
                    <div class="blog-2 blog-bg-2">
                        <div class="profile-user">
                            <img src="img/avatar/avatar-3.png" alt="blog-2">
                        </div>
                        <h6>By Maria Blank</h6>
                        <div class="info">
                            <h3>
                                <a href="blog-details.html">Find Your Dream Car</a>
                            </h3>
                            <p>Lorem Ipsum is simply dummy text of the printing and typesetting industry. Lorem Ipsum has been the industry's standard dummy text ever since the 1500s, when an unknown</p>
                            <h5>february 09, 2020<a href="blog-details.html" class="b-btn float-right">Rea more...!</a></h5>
                        </div>
                    </div>
                </div>
                <div class="slick-slide-item">
                    <div class="blog-2 blog-bg-1">
                        <div class="profile-user">
                            <img src="img/avatar/avatar-1.png" alt="blog-2">
                        </div>
                        <h6>By Eliane Perei</h6>
                        <div class="info">
                            <h3>
                ...
                <div class="slick-slide-item">
                    <div class="blog-2 blog-bg-3">
                        <div class="profile-user">
                            <img src="img/avatar/avatar-2.png" alt="blog-2">
                        </div>
                        <h6>By Eliane Perei</h6>
                        <div class="info">
                            <h3>
                            ...
                            <p>Lorem Ipsum is simply dummy text of the printing and typesetting industry. Lorem Ipsum has been the industry's standard dummy text ever since the 1500s, when an unknown</p>
                            <h5>March 09, 2020<a href="blog-details.html" class="b-btn float-right">Rea more...!</a></h5>
                        </div>
                    </div>
                </div>
            </div>
